...
comb_valid = {
    ...
    ('android', 'x86', 'chrome_shell'): ['(.*).apk$', 297098, 307000],
    ('android', 'x86_64', 'chrome_shell'): ['(.*).apk$', 297098, 307000],
    ('android', 'arm', 'chrome_shell'): ['(.*).apk$', 297098, 307000],
    ('android', 'arm64', 'chrome_shell'): ['(.*).apk$', 297098, 307000],

    ('android', 'x86', 'webview_shell'): ['(.*).apk$', 297098, 307000],
    ('android', 'x86_64', 'webview_shell'): ['(.*).apk$', 297098, 307000],
